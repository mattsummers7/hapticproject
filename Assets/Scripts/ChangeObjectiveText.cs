...
{
    //objective text controller. sets what the objective text should be and is activated through static bools across the scene.
    ...
    public IEnumerator ShowText(bool objective) //animation for text fades it after 5 seconds
    {
